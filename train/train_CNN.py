...
def train_CNN(X_train, X_test, X_validation, y_train, y_test, y_validation, batch_size = 100, epochs = 100, lr = 0.05, dropout=0.18, early_stopping=10):
...
if __name__ == "__main__":
    ...
    model, losses, losses_validation, train_accuracy, test_accuracy = train_CNN(X_train, X_test, X_validation, y_train, y_test, y_validation, args.batch_size, args.epochs, args.lr)

    torch.save(model.state_dict(), 'trained_models/models/CNN_' + date + \
    ...
    fig.savefig('trained_models/results/CNN_' + date + \
        '_epochs_' + str(args.epochs) + \
        '_batch_size_' + str(args.batch_size) + \
